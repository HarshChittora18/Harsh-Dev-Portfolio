  ...
  return (
    <div className="contact-us-holder">
      <div className="contact-us-left-holder">
        <h1 className="heading-font-portfolio">GET IN TOUCH</h1>
        <div>
          <p>
            Say hello at{" "}
            <a
              href="mailto:harshchittora18@gmail.com"
              className="clicks-contact-us"
            >
              harshchittora18@gmail.com
            </a>
          </p>
          <p>
        ...
        <div className="contact-us-logo-holder">
          <div>
            ...
            <div>
            <Link
                to="https://www.github.com/HarshChittora18"
                style={{ display: "flex" }}
              >
            ...
            <div>
            <Link
                to="https://www.twitter.com/harshchittora18"
                style={{ display: "flex" }}
              >
